...
type VA struct {
	InitialOwnerEquity                     float64 `json:"InitalOwnerEquity"`
	PercentDividendsToDistribute           float64 `json:"PercentDividendsToDistribute"`
	Description                            string  `json:"Description"`
	LastDividendsDistribution              string  `json:"LastDividendsDistribution"`
	ImageName                              string  `json:"ImageName"`
	ForceAssignJobsToPilots                bool    `json:"ForceAssignJobsToPilots"`
	AutomaticallyAssignJobWhenTaken        bool    `json:"AutomaticallyAssignJobWhenTaken"`
	AutomaticallyAssignJobWhenLoaded       bool    `json:"AutomaticallyAssignJobWhenLoaded"`
	RestrictEmployeesUsage                 bool    `json:"RestrictEmployeesUsage"`
	...
	LastComputationDate                    string  `json:"LastComputationDate"`
	ComputedMemberCount                    int     `json:"ComputedMemberCount"`
	ComputedAircraftCount                  int     `json:"ComputedAircraftsCount"`
	ComputedNumberOfFlights30Days          int     `json:"ComputedNumberOfFlights30Days"`
	ComputedNumberOfFlightHours30Days      float64 `json:"ComputedNumberOfFlightHours30Days"`
	ComputedMostUsedAirports               string  `json:"ComputedMostUsedAirports"`
	ID                                     string  `json:"Id"`
	...
	EnableCargoAndChartersLoadingTime      bool    `json:"EnableCargosAndChartersLoadingTime"`
	...
	CurrentBadgeID                         string  `json:"CurrentBadgeId"`
